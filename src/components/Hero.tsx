...
export const Hero = () => {
  ...
  return (
    <section className="bg-gradient-to-br from-orange-50 to-white dark:from-orange-950 dark:to-gray-900 py-20">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center bg-orange-100 text-orange-700 px-4 py-2 rounded-full text-sm font-medium mb-6">
            ...
            O Zelo Financeiro é a plataforma completa para gerenciar suas finanças pessoais e empresariais. 
          ...
          <div className="bg-background rounded-2xl shadow-xl p-8 mb-16 border border-border">
            <img 
              src="https://cdn.jsdelivr.net/gh/mathuzabr/img-packtypebot/mordomo.jpg" 
              alt="Dashboard do Zelo Financeiro"
            ...
            <div className="text-center">
              <div className="bg-green-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl font-bold text-green-600">R$</span>
                              ...
                              <h3 className="font-semibold text-foreground">Receitas Controladas</h3>
